    ...
    <button class="btn btn-utama" type="SUBMIT"><i class="flaticon2-files-and-folders"></i> Simpan</button>
        ...
        <?php 
                    ...
                    <?php echo ucfirst(str_replace("_"," ",$col->Comment)) ?> 
                        ...
                        <input type="file" accept="application/pdf" name="<?php echo $col->Field ?>" class="form-control" />
                     </div>
                      
                      <?php 
                        }elseif($col->Field=="periode"){
                            ?>
                       ...
                       <select  name="<?php echo $col->Field ?>" class="form-control selectza">
                          ...
                          <option <?php echo $data->{$col->Field}=='Desember - Maret'?'selected':'' ?> >Desember - Maret</option>
                          <option <?php echo $data->{$col->Field}=='April - Juli'?'selected':'' ?> >April - Juli</option>
                          <option <?php echo $data->{$col->Field}=='Agustus - November'?'selected':'' ?> >Agustus - November</option>
                      ...
                      <?php 
                       ...
                       <select  name="<?php echo $col->Field ?>" class="form-control">
                          ...
                          <option <?php echo $data->{$col->Field}=='Opening'?'selected':'' ?> >Opening</option>
                          <option <?php echo $data->{$col->Field}=='Home'?'selected':'' ?> >Home</option>
