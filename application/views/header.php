...
<body style="font-family: 'PT Sans', sans-serif;">
 ...
 <li class="nav-item">
   ...
   <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('kendaraan') ?>"><i class="flaticon-list"></i> Data Biaya Sewa</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('sewa') ?>"><i class="flaticon-open-box"></i> Data Sewa</a>
              </li>
...
<div class="container-fluid">
    <div class="row">
        ...
        <?php if($_SESSION['level']=='Admin'){?>
          ...
          <div  class="SIDEMENU col-sm-2" style="padding:20px;box-shadow: rgba(0, 0, 0, 0.35) 10px 0 10px -10px; background-image: linear-gradient(<?php echo $comp[0]->warna_utama ?>, <?php echo $comp[0]->warna_kedua ?>);">
             ...
             <center>
              <img style="filter: grayscale(0);margin-bottom: 20%;" height="100" src="<?php echo site_url().$comp[0]->foto ?>" />
   ...
   <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('sewa') ?>"><i class="flaticon-placeholder"></i> Data Sewa</a>
              </li>
