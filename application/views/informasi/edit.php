        			    ...
        			    <label class="AppLabel">
        			      Tipe
        			       ...
        			       <select class="form-control" name="tipe">
        			           <option <?php echo $data->{$col->Field}=='Aktifitas Fisik'?'selected':'' ?> >Aktifitas Fisik</option>
        			           <option <?php echo $data->{$col->Field}=='Info Diabetes'?'selected':'' ?> >Info Diabetes</option>
        			       </select>
